...
class Start extends React.Component {
  render(){
    ...
    <Link to='./signin'> <span style={{ position: 'relative',top: '-5.8em',left: '40em'}}>Sign In </span></Link>
    <center>
    <img style={{width: '42em',height: '9em',top: '-4em',left: '0.2em',position: 'relative'}} src='https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSsiEogSnNA7vzKLae9G61tWEQwZMjH9bq9EgZTVn856mcVKBzt'/>
